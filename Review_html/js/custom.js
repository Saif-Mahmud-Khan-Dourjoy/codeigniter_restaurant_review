...
$(function() {
    $('[id="Taste"]').on('change input', function() {
        rangePercent = $('[id="Taste"]').val();
        $('[id="Taste"], h4>span').css('filter', 'hue-rotate(-' + rangePercent + 'deg)');
    });
    $('[id="Quantity"]').on('change input', function() {
        rangePercent = $('[id="Quantity"]').val();
        $('[id="Quantity"], h4>span').css('filter', 'hue-rotate(-' + rangePercent + 'deg)');
    });
    $('[id="Ambiance"]').on('change input', function() {
        rangePercent = $('[id="Ambiance"]').val();
        $('[id="Ambiance"], h4>span').css('filter', 'hue-rotate(-' + rangePercent + 'deg)');
    });
    $('[id="Service"]').on('change input', function() {
        rangePercent = $('[id="Service"]').val();
        $('[id="Service"], h4>span').css('filter', 'hue-rotate(-' + rangePercent + 'deg)');
    });
});